...
var len__29222__auto___30625 = arguments.length;
var i__29223__auto___30626 = (0);
while(true){
if((i__29223__auto___30626 < len__29222__auto___30625)){
args__29229__auto__.push((arguments[i__29223__auto___30626]));

var G__30627 = (i__29223__auto___30626 + (1));
i__29223__auto___30626 = G__30627;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__29230__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30622){
var G__30623 = cljs.core.first.call(null,seq30622);
var seq30622__$1 = cljs.core.next.call(null,seq30622);
var G__30624 = cljs.core.first.call(null,seq30622__$1);
var seq30622__$2 = cljs.core.next.call(null,seq30622__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__30623,G__30624,seq30622__$2);
});
...
if(cljs.core.truth_((function (){var or__28051__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__28676__auto__,writer__28677__auto__,opt__28678__auto__){
return cljs.core._write.call(null,writer__28677__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__28039__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__28039__auto__){
var or__28051__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__28051__auto__)){
return or__28051__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30628_SHARP_){
return !((cljs.core.meta.call(null,p1__30628_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__30629__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__28051__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e30633){var _e__29616__auto__ = e30633;
return false;
}})();
if(cljs.core.truth_(or__28051__auto__)){
return or__28051__auto__;
...
}catch (e30635){var _e__29616__auto__ = e30635;
return false;
}}
})())){
...
var _STAR_current_state_STAR_30637 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__30638 = opts;
...
var markup_db = cljs.core.get.call(null,map__30638__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_30637;
}});
...
;
var temp__4655__auto___30642 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___30642)){
var managed_print_level_30643 = temp__4655__auto___30642;
var _STAR_print_level_STAR_30641_30644 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_30643;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_30641_30644,managed_print_level_30643,temp__4655__auto___30642,writer,opts,job_fn){
return (function (p1__30640_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__30640_SHARP_,null);
});})(_STAR_print_level_STAR_30641_30644,managed_print_level_30643,temp__4655__auto___30642,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_30641_30644;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1512059516900
