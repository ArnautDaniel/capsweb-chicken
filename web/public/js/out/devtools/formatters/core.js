...
var and__28039__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__28039__auto__){
var or__28051__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e36636){var _e__29616__auto__ = e36636;
return false;
...
}catch (e36638){var _e__29616__auto__ = e36638;
return false;
...
}catch (e36640){var _e__29616__auto__ = e36640;
return false;
...
}catch (e36642){var _e__29616__auto__ = e36642;
return false;
...
}catch (e36644){var _e__29616__auto__ = e36644;
return false;
}})())){
...
}catch (e36646){var _e__29616__auto__ = e36646;
return false;
}})())){
...
var _STAR_current_state_STAR_36648 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__28051__auto__ = config;
if(cljs.core.truth_(or__28051__auto__)){
return or__28051__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_36648;
}});
});
...
return (function() { 
var G__36650__delegate = function (args){
...
var G__36650 = function (var_args){
var args = null;
...
while (G__36651__i < G__36651__a.length) {G__36651__a[G__36651__i] = arguments[G__36651__i + 0]; ++G__36651__i;}
  args = new cljs.core.IndexedSeq(G__36651__a,0,null);
} 
return G__36650__delegate.call(this,args);};
G__36650.cljs$lang$maxFixedArity = 0;
G__36650.cljs$lang$applyTo = (function (arglist__36652){
var args = cljs.core.seq(arglist__36652);
return G__36650__delegate(args);
});
G__36650.cljs$core$IFn$_invoke$arity$variadic = G__36650__delegate;
return G__36650;
})()
;
});
...
var pre_handler = (function (){var or__28051__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__28051__auto__)){
return or__28051__auto__;
} else {
...
var post_handler = (function (){var or__28051__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__28051__auto__)){
return or__28051__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1512059527029
