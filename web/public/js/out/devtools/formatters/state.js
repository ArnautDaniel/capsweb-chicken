...
var len__29222__auto___30616 = arguments.length;
var i__29223__auto___30617 = (0);
while(true){
if((i__29223__auto___30617 < len__29222__auto___30616)){
args__29229__auto__.push((arguments[i__29223__auto___30617]));

var G__30618 = (i__29223__auto___30617 + (1));
i__29223__auto___30617 = G__30618;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29230__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq30614){
var G__30615 = cljs.core.first.call(null,seq30614);
var seq30614__$1 = cljs.core.next.call(null,seq30614);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__30615,seq30614__$1);
});
...
return (p1__30619_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1512059516787
