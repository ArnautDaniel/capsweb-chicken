...
return (new CustomEvent(event_name,(function (){var obj36867 = {"detail":data};
return obj36867;
})()));
} else {
...
var f = (function (){var pred__36874 = cljs.core._EQ_;
var expr__36875 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__36874.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__36875))){
return ((function (pred__36874,expr__36875){
return (function (p1__36868_SHARP_){
return console.warn(p1__36868_SHARP_);
});
;})(pred__36874,expr__36875))
} else {
if(cljs.core.truth_(pred__36874.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__36875))){
return ((function (pred__36874,expr__36875){
return (function (p1__36869_SHARP_){
return console.debug(p1__36869_SHARP_);
});
;})(pred__36874,expr__36875))
} else {
if(cljs.core.truth_(pred__36874.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__36875))){
return ((function (pred__36874,expr__36875){
return (function (p1__36870_SHARP_){
return console.error(p1__36870_SHARP_);
});
;})(pred__36874,expr__36875))
} else {
return ((function (pred__36874,expr__36875){
return (function (p1__36871_SHARP_){
return console.log(p1__36871_SHARP_);
});
;})(pred__36874,expr__36875))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__36878){
...
var eval_fn = cljs.core.get.call(null,map__36879__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__36881_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__36883,(0),null);
var v = cljs.core.nth.call(null,vec__36883,(1),null);
...
}catch (e36888){if((e36888 instanceof Error)){
var e = e36888;
return not_found;
} else {
throw e36888;
...
//# sourceMappingURL=utils.js.map?rel=1512059527464
