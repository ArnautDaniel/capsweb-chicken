...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__28676__auto__,writer__28677__auto__,opt__28678__auto__){
return cljs.core._write.call(null,writer__28677__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__32591 = o;
(G__32591[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__32592__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__32592 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__32593__i = 0, G__32593__a = new Array(arguments.length -  0);
while (G__32593__i < G__32593__a.length) {G__32593__a[G__32593__i] = arguments[G__32593__i + 0]; ++G__32593__i;}
  args = new cljs.core.IndexedSeq(G__32593__a,0,null);
} 
return G__32592__delegate.call(this,args);};
G__32592.cljs$lang$maxFixedArity = 0;
G__32592.cljs$lang$applyTo = (function (arglist__32594){
var args = cljs.core.seq(arglist__32594);
return G__32592__delegate(args);
});
G__32592.cljs$core$IFn$_invoke$arity$variadic = G__32592__delegate;
return G__32592;
})()
;
} else {
...
if(cljs.core.truth_((function (){var and__28039__auto__ = !((jsprops == null));
if(and__28039__auto__){
var and__28039__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__32597 = jsprops;
(G__32597["defaultValue"] = value);

(G__32597["onChange"] = ((function (G__32597,v,value,on_change){
return (function (p1__32596_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__32596_SHARP_);
});})(G__32597,v,value,on_change))
);
...
var vec__32600 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__32600,(0),null);
var id = cljs.core.nth.call(null,vec__32600,(1),null);
var class$ = cljs.core.nth.call(null,vec__32600,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___32604 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___32604 == null)){
} else {
var key_32605 = temp__4661__auto___32604;
(jsprops["key"] = key_32605);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__32606 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__32606["name"] = c);
...
var len__29222__auto___32611 = arguments.length;
var i__29223__auto___32612 = (0);
while(true){
if((i__29223__auto___32612 < len__29222__auto___32611)){
args__29229__auto__.push((arguments[i__29223__auto___32612]));

var G__32613 = (i__29223__auto___32612 + (1));
i__29223__auto___32612 = G__32613;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29230__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq32609){
var G__32610 = cljs.core.first.call(null,seq32609);
var seq32609__$1 = cljs.core.next.call(null,seq32609);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__32610,seq32609__$1);
});
...
break;
default:
var G__32616 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__32616;
continue;
...
var n__28998__auto___32618 = a.length;
var i_32619 = (0);
while(true){
if((i_32619 < n__28998__auto___32618)){
(a[i_32619] = reagent.impl.template.as_element.call(null,(a[i_32619])));

var G__32620 = (i_32619 + (1));
i_32619 = G__32620;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__28998__auto___32621 = a.length;
var i_32622 = (0);
while(true){
if((i_32622 < n__28998__auto___32621)){
var val_32623 = (a[i_32622]);
if((cljs.core.vector_QMARK_.call(null,val_32623)) && ((reagent.impl.template.key_from_vec.call(null,val_32623) == null))){
(o["no-key"] = true);
} else {
}

(a[i_32622] = reagent.impl.template.as_element.call(null,val_32623));
...
var ctx = ({});
var vec__32625 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__32625,(0),null);
var derefed = cljs.core.nth.call(null,vec__32625,(1),null);
...
var G__32628 = (cljs.core.count.call(null,argv) - first_child);
switch (G__32628) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__32628){
...
//# sourceMappingURL=template.js.map?rel=1512059521941
