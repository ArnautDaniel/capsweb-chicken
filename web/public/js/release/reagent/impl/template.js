...
var G__17684 = o;
(G__17684[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__17685__delegate = function (args){
...
while (G__17686__i < G__17686__a.length) {G__17686__a[G__17686__i] = arguments[G__17686__i + 0]; ++G__17686__i;}
  args = new cljs.core.IndexedSeq(G__17686__a,0,null);
} 
return G__17685__delegate.call(this,args);};
G__17685.cljs$lang$maxFixedArity = 0;
G__17685.cljs$lang$applyTo = (function (arglist__17687){
var args = cljs.core.seq(arglist__17687);
return G__17685__delegate(args);
});
...
var G__17690 = jsprops;
(G__17690["defaultValue"] = value);

(G__17690["onChange"] = ((function (G__17690,v,value,on_change){
return (function (p1__17689_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__17689_SHARP_);
});})(G__17690,v,value,on_change))
);
...
var vec__17693 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17693,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17693,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17693,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___17697 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___17697 == null)){
} else {
var key_17698 = temp__4661__auto___17697;
(jsprops["key"] = key_17698);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__17699 = reagent.impl.template.__GT_NativeWrapper();
(G__17699["name"] = c);
...
var G__17700 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__17700) : reagent.impl.template.as_element.call(null,G__17700));
} else {
...
var len__8839__auto___17705 = arguments.length;
var i__8840__auto___17706 = (0);
while(true){
if((i__8840__auto___17706 < len__8839__auto___17705)){
args__8846__auto__.push((arguments[i__8840__auto___17706]));

var G__17707 = (i__8840__auto___17706 + (1));
i__8840__auto___17706 = G__17707;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq17703){
var G__17704 = cljs.core.first(seq17703);
var seq17703__$1 = cljs.core.next(seq17703);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__17704,seq17703__$1);
});
...
break;
default:
var G__17710 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__17710;
continue;
...
var n__8615__auto___17712 = a.length;
var i_17713 = (0);
while(true){
if((i_17713 < n__8615__auto___17712)){
(a[i_17713] = reagent.impl.template.as_element((a[i_17713])));

var G__17714 = (i_17713 + (1));
i_17713 = G__17714;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8615__auto___17715 = a.length;
var i_17716 = (0);
while(true){
if((i_17716 < n__8615__auto___17715)){
var val_17717 = (a[i_17716]);
if((cljs.core.vector_QMARK_(val_17717)) && ((reagent.impl.template.key_from_vec(val_17717) == null))){
(o["no-key"] = true);
} else {
}

(a[i_17716] = reagent.impl.template.as_element(val_17717));

var G__17718 = (i_17716 + (1));
i_17716 = G__17718;
continue;
} else {
}
...
var ctx = ({});
var vec__17719 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17719,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17719,(1),null);
...
var G__17722 = (cljs.core.count(argv) - first_child);
switch (G__17722) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__17722){
